...
## API code snippets
 ...
 - The UAT version of this API is hosted by the following url: [https://euroconnector.uat.fitek.com/api/public/index.html](https://euroconnector.uat.fitek.com/api/public/index.html)
